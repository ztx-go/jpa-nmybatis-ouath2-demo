...
public class ConsumerController {
    ...
    //    nacos的命名服务，由nacos提供，需要nacos的注解@NacosInjected 来注入
    @NacosInjected
    ...
    public String consumer() throws IllegalStateException, NacosException {
        ...
        if (false) {
            ...
            instance = namingService.selectOneHealthyInstance("jpa-mybatis-demo");
        }
        // <2> 执行请求
        return restTemplate.getForObject("http://" + instance.toInetAddr() + "/nacos/provider/demo",
                String.class);
    }
}
